      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between gap-3 h-auto min-h-[66px] sm:min-h-[72px] py-2">
          ...
          <div className="flex items-center gap-2 sm:gap-2.5">
            {/* Device Dropdown - แสดงเฉพาะบนหน้าจอขนาดใหญ่ขึ้นไป เพื่อทดสอบมุมมอง */}
          ...
          <div className="pt-2 border-t border-slate-100 space-y-2">
            ...
            {userInfo ? (
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-2 py-2.5 px-3 bg-gradient-to-r from-blue-700 to-indigo-800 hover:from-blue-800 hover:to-indigo-900 text-white rounded-xl text-xs font-semibold shadow-xs transition-all active:scale-[0.99] cursor-pointer"
              >
                <svg
                  version="1.1"
                  xmlns="http://www.w3.org/2000/svg"
